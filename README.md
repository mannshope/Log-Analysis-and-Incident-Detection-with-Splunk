...
## 🚀 How to Reproduce
1. Upload the splunk_login_dataset.csv to your Splunk instance.

2. Set the source type to _json or csv (ensure headers are recognized).

3. Run the SPL queries provided in the "Investigation" section above.

4. Visualize the results using **Statistics** and **Visualization** tabs for better reporting.
